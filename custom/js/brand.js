...
$(document).ready(function() {
	...
	$("#submitBrandForm").unbind('submit').bind('submit', function() {
		...
		if(brandName == "") {
			$("#brandName").after('<p class="text-danger">HSN Code no. field is required</p>');
		...
		if(brandStatus == "") {
			$("#brandStatus").after('<p class="text-danger">HSN Code no. field is required</p>');
	...
	if(brandId) {
		...
		$.ajax({
			...
			success:function(response) {
				...
				$('#editBrandName').val(response.hsn_name);
				// setting the brand status value
				$('#editBrandStatus').val(response.hsn_active);
				// brand id 
				$(".editBrandFooter").after('<input type="hidden" name="brandId" id="brandId" value="'+response.hsn_id+'" />');
				...
				$('#editBrandForm').unbind('submit').bind('submit', function() {
					...
					if(brandName == "") {
						$("#editBrandName").after('<p class="text-danger">HSN Code no. field is required</p>');
					...
					if(brandStatus == "") {
						$("#editBrandStatus").after('<p class="text-danger">HSN Code no. field is required</p>');
...
function removeBrands(brandId = null) {
	if(brandId) {
		...
		$.ajax({
			...
			dataType: 'json',
			success:function(response) {
				$('.removeBrandFooter').after('<input type="hidden" name="removeBrandId" id="removeBrandId" value="'+response.hsn_id+'" /> ');
