...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		?>			
  		...
  		<form class="form-horizontal" method="POST" action="php_action/wcreateOrder.php" id="createOrderForm">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="vat" class="col-sm-3 control-label gst">GST</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentPlace" id="paymentPlace">
				      	<option value="1">In Rajasthan</option>
				      	<option value="2">Out Of Rajasthan</option>
				      </select>
				    </div>
				  </div> <!--/form-group-->							  
			  </div> <!--/col-md-6-->
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/weditOrder.php" id="editOrderForm">

  			<?php $orderId = $_GET['i'];

  			$sql = "SELECT worders.order_id, worders.order_date, worders.client_name, worders.client_contact, worders.sub_total, worders.vat, 
			worders.total_amount, worders.discount, worders.grand_total, worders.paid, worders.due, worders.payment_type, worders.payment_status, 
			worders.payment_place, worders.gstn FROM worders 	
					WHERE worders.order_id = {$orderId}";
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentType" id="paymentType" >
						...
						<option value="3" <?php if($data[11] == 4) {
				      		echo "selected";
				      	} ?> >Credit Card</option>
						<option value="3" <?php if($data[11] == 5) {
				      		echo "selected";
				      	} ?> >UPI</option>
				      </select>
				    </div>
...
<script src="custom/js/worder.js"></script>
