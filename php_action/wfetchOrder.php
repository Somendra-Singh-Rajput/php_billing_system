...
$sql = "SELECT order_id, order_date, client_name, client_contact, payment_status FROM worders WHERE order_status = 1";
 ...
 while($row = $result->fetch_array()) {
	...
	<div class="btn-group">
	  ...
	  <ul class="dropdown-menu">
	    <li><a href="worders.php?o=editOrd&i='.$orderId.'" id="editOrderModalBtn"> <i class="glyphicon glyphicon-edit"></i> Edit</a></li>
